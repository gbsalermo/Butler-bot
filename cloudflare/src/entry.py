    ...
    async def fetch(self,request):
        ...
        if request.method=="POST" and path=="/telegram/webhook":
            ...
            if message:
                ...
                # Continuação de uma sugestão acadêmica confirmável permanece no Core.
